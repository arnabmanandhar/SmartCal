...
const int io5Pin = 5; // IO5 is mapped to physical pin 5

// ===========================
// Enter your server information
// ===========================
String serverName = "IPaddress"; //Example: 192.168.0.1
...
//  
//  int buttonState = digitalRead(io5Pin);
//  
//  if (buttonState == HIGH && currentMilliseconds - latestPicture >= pictureInterval) {
//    takePicture();
